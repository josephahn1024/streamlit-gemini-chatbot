...
if prompt:
    ...
    response = send_prompt("You are an AI emotional support. Offer recommendations on how the user can improve their mood. The user is currently feeling {mood}. Respond with how the user can improve their {mood}. Here the user had said;" + prompt)
